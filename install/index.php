...
<body>
    <div class="container">
        ...
        ?>
            ...
            <form method="POST">
                <style>
                    ...
                    .field label { font-family:'JetBrains Mono', monospace; font-size: 11px; color: var(--ink-mute); text-transform: uppercase; letter-spacing: 0.08em; }
                    .field input { background: var(--bg); border: 1px solid var(--line); border-radius: 10px; padding: 12px 14px; color: var(--ink); font: inherit; font-size: 14px; outline: none; }
        ...
        ?>
            ...
            <form method="POST">
                <h3 style="font-size: 14px; margin-bottom: 12px; color: var(--accent);">Admin Account</h3>
                <div class="field">
                    <label>Username</label>
                ...
                <h3 style="font-size: 14px; margin: 20px 0 12px; color: var(--accent);">SMTP Settings (Optional)</h3>
        ...
        <?php elseif ($stage === 4): ?>
            ...
            <div style="background: var(--bg); border: 1px solid var(--line); border-radius: 14px; padding: 20px; margin-bottom: 30px;">
